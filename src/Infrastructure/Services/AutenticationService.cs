...
namespace Infrastructure.Services
{
    ...
    {
        public class AutenticacionService : ICustomAutenticationService
        {
            ...
            public string Authenticate(AuthenticationRequest credentialsRequest)
            {
                ...
                claimsForToken.Add(new Claim("username", user.Name)); //quiere usar la API por lo general lo que espera es que se estén usando estas keys.
